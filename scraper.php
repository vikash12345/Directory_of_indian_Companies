	...
	$html	=	file_get_html($link);
		...
		if($html)
		{
			...
			foreach($html->find("/html/body/div/div/div[@itemtype='http://schema.org/Organization']") as $element)
			{
				...
				$region		=	$element->find("span[@itemprop='addressRegion']",0)->plaintext;
				$country	=	$element->find("span[@itemprop='addressCountry']",0)->plaintext;
				...
				scraperwiki::save(array('nameofcompany','phone','fulladdress','region','country','businesstype','des','link'), $record);
			}
		}
